            ...
            <div class="inner meum_g">
              ...
              <form id="forms" class="slide-text fon-s80-pc">
                ...
                <div class="input_area" style="overflow: hidden;height: 0;padding: 0;">
                  <input type="text" class="textform feed6" name="entry.332781224" rows="1" value="<?php the_field('item'); ?>">
                </div>
              ...
              <script type="text/javascript">
                jQuery(function($) {
                  ...
                  function postToGoogle() {
                    var googleformid = "https://docs.google.com/forms/d/e/<?php the_field('googleformid'); ?>/formResponse";
