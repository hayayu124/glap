<div class="article con_b udr mar-b1 shuffle-item pos-r" data-groups='["<?php get_template_part('snp/cat_slug'); ?>"]'>
	...
	<div class="con_b_udr wrap atc">
		<div class="con_b_udr inner t-wh">
			<div class="con_b atc cat mar-b05 fon-2 dis-ib <?php get_template_part('snp/cat_description'); ?>" style="border-bottom: 2px solid <?php get_template_part('snp/cat_description'); ?>;">
