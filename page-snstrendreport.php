          ...
          <div class="header_wrap pos-r">
            <div class="inner">
              <div class="title_wrap">
                <h1 class="fon-6">SNS TREND REPORT</h1>
              </div>
            </div>
          </div>
          ...
          <div class="contents_left_wrap contents_wrap fle-1">
            <div class="inner fon-s80-pc">
              <div class="text fon-1 fon-b mar-t1 mar-b2">
                こちらのフォームに必要事項を入力して送信していただくと、SNSの最新トレンドをまとめた資料をメールでお送りいたします。
              </div>
            </div>
          </div>
              ...
              <script type="text/javascript">
                jQuery(function($) {
                  ...
                  function postToGoogle() {
                    ...
                    var feed6 = $('[name=entry\\.1173409106]').val();
                    $.ajax({
                      url: "https://docs.google.com/forms/d/e/1FAIpQLSerhwrOazO426GmxJDAijXVKdl7938IBrEo6dO2K2ItKJSGwA/formResponse",
                      data: {
